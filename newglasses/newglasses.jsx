...
function CartoonSlide() {
  return (
    <div style={{
      ...
      <img
        src={"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAgAAAAIACAIAAAB7GkOtAAAAAXNSR0IArs4c6QAAAERlWElmTU0AKgAAAAgAAYdpAAQAAAABAAAAGgAAAAAAA6ABAAMAAAABAAEAAKACAAQAAAABAAACAKADAAQAAAABAAACAAAAAAAL[...]"}
...
The ask is small. Test the split ratio — five runs, same seed, one afternoon. Transfer test on external data. Audit your geographic transformations. Check your code against your hardware before you [...]
  ...
  // Slide 12: Closing
  `We don't need a breakthrough. We don't need a new framework, a new paradigm, a new model architecture. We need to look at what we already have. That's the turn. The unexamined default is not w[...]
